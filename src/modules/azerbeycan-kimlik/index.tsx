...
export default function AzerbeycanKimlik() {
  ...
  useEffect(() => {
    ...
    setImages(Array.from({length: 358}, (_, i) => `wexazeri${i + 1}.jpeg`))
  },[])
      ...
      <Main>
        <div className='mb-6'>
          <div className="flex items-center gap-3">
            <h1 className='text-2xl md:text-3xl font-bold tracking-tight'>Azerbeycan Kimlik Arşivi</h1>
          </div>
        ...
        {selectedImg && (
          ...
          >
            ...
            >
              ...
              <img
                src={`/images/wexazeri/${selectedImg}`}
...
const topNav = [
  {
    title: "Azerbeycan Kimlik Arşivi",
    href: "/azerbeycan-kimlik",
    isActive: true,
  }
]